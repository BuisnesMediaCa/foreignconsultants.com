...
$('input[name="amount_pages"]').mask('00000');
$('input[name="price_page"]').mask('0000,00');
$('input[name="total_price"]').mask('00000,00');
$('input[name="total"]').mask('00000,00');
$('input[name="card_number"]').mask('0000000000000000');
$('input[name="card_month"]').mask('00');
$('input[name="card_year"]').mask('00');
$('input[name="card_code"]').mask('0000');
$('input[name="sign_date"]').mask('00/00/00');
...
<table width="700" border="0" cellspacing="0" cellpadding="0">
  ...
  <form method="post" action="./sendmail.php" id="sender">
    <div class="twrapper">
      ...
      <table>
        ...
        <tr>
          ...
          <td>          
            ...
            <p><label><strong>State:</strong></label> <span>
            <select name="purpose_state">
  ...
  <option value="Wyoming">Wyoming</option>
        ...
        <tr>
          ...
          <td>          
            <input type="radio" name="eval_12" value="Next day Rush Service $160"/> Next day Rush Service <span class="rpice">$160</span><br/>
        ...
        <tr>
          ...
          <td>          
            <input type="radio" name="eval_13" value="Priority Mail with tracking number within USA/Canada (2-3 business days) $30"/> Priority Mail with tracking number within USA/Canada (2-3 business days) <span class="rpice">$30</span><br/>
        ...
        <tr>
          ...
          <td>          
            <table>
              ...
              <tr>
                <td><textarea name="school1"></textarea></td>          
                <td><textarea name="city_country1"></textarea></td>          
                <td><textarea name="certificate1"></textarea></td>         
                <td><textarea name="date_started1"></textarea></td>          
                <td><textarea name="date_completed1"></textarea></td>          
              </tr>   
              <tr>
                <td><textarea name="school2"></textarea></td>          
                <td><textarea name="city_country2"></textarea></td>          
                <td><textarea name="certificate2"></textarea></td>         
                <td><textarea name="date_started2"></textarea></td>          
                <td><textarea name="date_completed2"></textarea></td>          
              </tr>                
            </table>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>          
            <input type="radio" name="card_type" value="Visa"> Visa <input type="radio" name="card_type" value="MasterCard"> Master Card  <input type="radio" name="card_type" value="Discover"> Discover <input type="radio" name="card_type" value="American Express"> American Express <input type="radio" name="card_type" value="Any Debit Card"> Any Debit Card<br/>
            Card Number <span><input type="text" min="16" max="16" class="req" name="card_number"><br/></span>
            Expiration Date <span class="price"><input type="text" min="2" class="req" max="2" name="card_month"> <input type="text" min="2" max="2" class="req" name="card_year"> Security Code <input type="text" min="4" class="req" max="4" name="card_code"></span>
            <br><label><strong>Address (Numbers Only): </strong></label> <input type="text" name="user_addr">
            <br><label><strong>Zip Code: </strong></label> <input type="text" name="user_zip">                        
            <br><label><strong>Cardholders name: </strong></label> <input type="text" name="card_name">
          </td>
        </tr>
      </table>
    ...
    <p>
      <strong>Signature of Applicant</strong> (Do Not Print) <input type="text" name="sign_name" value="" class="sign req" > <strong>Date</strong> <span><input type="text" name="sign_date" value="" placeholder="MM/DD/YYYY" class="datef req"></span>
      </p>
    ...
    <div id="rmore" style="display: none;">
      ...
      <br>
      <div class="g-recaptcha" data-sitekey="6LfMSjkUAAAAAHY_6VI_F0S3xwGnzRw6woYiCi70" style="margin-left: 200px;"></div>
