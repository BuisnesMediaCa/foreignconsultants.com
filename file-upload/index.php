...
$auth_users = array(
    'admin' => '$2y$10$P4j/MzPHMb2fVoUdRqt/KuEiN94WfAWCBLpfuyLyVhqcupQarskja', //luckyfruit38
    'user' => '$2y$10$BTZraPCrkC3H0GjuG7tf0O48T0MhGQ2iJSsx2VxPl1RLIxi9NWBrC' //roundwood84
);
...
$root_path = $_SERVER['DOCUMENT_ROOT']. '/file-upload/php/files';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = 'file-upload/php/files';
...
$GLOBALS['exclude_items'] = array('index.php', '.gitignore', '.htaccess');
